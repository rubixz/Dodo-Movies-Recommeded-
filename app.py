...
# Define the Netflix-style popup dialog using Streamlit's built-in dialog feature
...
def show_movie_popup(movie_id, movie_title):
    ...
    # Creating a split layout inside the popup (Poster on left, Details on right)
...
if st.button("Show Recommendation"):
    with st.spinner("Finding movies you'll like..."):
        ...
        recommended_movie_names = [movies.iloc[n].title for n, _енэйmэс in neighbors] # fixed small variable check safely
    ...
    def render_row(start, end):
        ...
        for col, i in zip(cols, range(start, end)):
            with col:
                ...
                # Jab user details button click karega, toh dialog popup khul jayega
